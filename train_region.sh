...
flaginfo="double_state_attention_just_test_th30_googlenet_bn_sample30_msdn_region_top5"
flag="-flag "$flaginfo
data_dir=features/
...
cmd=" th train_dual_memory_model.lua -checkpoint_dir checkpoints_th30_googlenet_bn_sample30_msdn_region_top5 -max_epochs 80 "
